      ...
      <div>
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          <motion.p className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16">
            Exercitation et cupidatat sint eiusmod. Mollit deserunt duis Lorem
            elit amet officia enim consectetur. Consequat ex voluptate commodo
            quis Lorem id sunt veniam minim culpa est.
          </motion.p>
          {/* btn */}
